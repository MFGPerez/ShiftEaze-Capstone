        ...
        {popupMessage && (
          <div
            className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 rounded-md shadow-md ${
              popupMessage.color === "green" ? "bg-green-500 border-2 border-transparent border-green-400" : popupMessage.color === "red" ? "bg-red-500 border-2 border-transparent border-red-400" : "bg-yellow-500 border-2 border-transparent border-yellow-400"
            }`}
          >
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <h3
                className={`text-lg font-bold mb-4 ${
                  popupMessage.color === "green" ? "text-green-500" : popupMessage.color === "red" ? "text-red-500" : "text-yellow-500"
                }`}
              >
                {popupMessage.title}
              </h3>
