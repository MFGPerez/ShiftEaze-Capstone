...
const CalendarGrid = ({
      ...
      return (
        ...
        >
          <BlockComponent
            ...
            setStartDate={(date) =>
              moveBlock(block.id, row, date.getDate() - 1)
            }
  ...
  return (
    <div
      ref={drop}
      className="flex flex-col w-full max-w-[1500px] border border-gray-300 overflow-hidden bg-gray-200 mb-5 mx-auto relative"
    >
