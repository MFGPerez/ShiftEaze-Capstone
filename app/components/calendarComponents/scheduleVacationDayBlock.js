 ...
 * @returns {JSX.Element} The ScheduleVacationDayBlock component
 */
const ScheduleVacationDayBlock = ({
  id,
      ...
      >
        ...
        {isMultiMonth && (
          <span className="absolute right-0 flex items-center h-full pr-2">
            <HiOutlineChevronDoubleRight className="text-red-600 text-3xl" />
          </span>
        )}
      </button>
...
export default ScheduleVacationDayBlock;
